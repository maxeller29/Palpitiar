@echo off
cd /d "%~dp0"
git add dupla-sena.html lotoia-db.js index.html lotomania.html timemania.html diadesorte.html netlify/functions/resultado.js scripts/criar-historico-timemania.js scripts/criar-historico-diadesorte.js
git commit -m "feat: implementa Timemania e Dia de Sorte
